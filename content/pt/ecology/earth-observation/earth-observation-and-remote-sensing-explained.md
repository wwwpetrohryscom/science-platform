...
**Índices derivados e classificação.** A partir da refletância de superfície, calculam-se índices e mapas. O mais conhecido é o [NDVI](/en/glossary/ndvi), o índice de vegetação por diferença normalizada, explicado no artigo sobre o [NDVI](/pt/ecology/earth-observation/ndvi-explained) e generalizado no texto sobre os [índices de vegetação](/pt/ecology/earth-observation/vegetation-indices-and-monitoring). Classificar píxeis em categorias como floresta, água ou terra arável produz cartas de [ocupação do solo](/en/glossary/land-cover); compará-las ao longo do tempo é a [deteção de alterações na ocupação do solo](/pt/ecology/earth-observation/land-cover-change-detection).
...
Os artigos de apoio levam cada peça mais longe: [o que é a deteção remota](/pt/ecology/earth-observation/what-is-remote-sensing), o [programa Landsat](/pt/ecology/earth-observation/landsat-program-explained), os [satélites Sentinel](/pt/ecology/earth-observation/sentinel-satellites-explained), o [sistema MODIS](/pt/ecology/earth-observation/modis-earth-observation-system), o [NDVI](/pt/ecology/earth-observation/ndvi-explained) e a família mais ampla dos [índices de vegetação](/pt/ecology/earth-observation/vegetation-indices-and-monitoring), a [deteção de alterações na ocupação do solo](/pt/ecology/earth-observation/land-cover-change-detection), a [monitorização da desflorestação por satélite](/pt/ecology/earth-observation/satellite-deforestation-monitoring), a [vigilância de incêndios a partir do espaço](/pt/ecology/earth-observation/wildfire-monitoring-from-space), os [sistemas de monitorização da seca](/pt/ecology/earth-observation/drought-monitoring-systems), as [observações da cor do oceano](/pt/ecology/earth-observation/ocean-color-observations), a [altimetria por satélite](/pt/ecology/earth-observation/satellite-altimetry-explained), os [produtos de dados de observação da Terra](/pt/ecology/earth-observation/earth-observation-data-products), o [programa Copernicus](/pt/ecology/earth-observation/copernicus-programme-explained) e um balanço franco das [limitações e incertezas da deteção remota](/pt/ecology/earth-observation/remote-sensing-limitations-and-uncertainty). Em conjunto, explicam como o planeta é vigiado a partir da órbita e como ler o que essa vigilância produz.
