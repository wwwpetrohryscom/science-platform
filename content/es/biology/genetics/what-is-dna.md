...
faq:
  - question: Si el ADN es el plano de la obra, ¿por qué los gemelos idénticos no son idénticos?
    answer: El ADN no es un plano, sino una receta cuya ejecución es sensible al contexto. Los gemelos idénticos comparten genotipo, pero se desarrollan en posiciones prenatales distintas, acumulan mutaciones distintas, viven entornos distintos y sufren modificaciones epigenéticas distintas. Las diferencias fenotípicas entre gemelos idénticos son la prueba de que el ADN infradetermina al organismo.
  - question: ¿Qué parte del genoma humano es «basura»?
...
El ADN es un polímero formado por cuatro tipos de subunidad, los nucleótidos, que se identifican por la base que llevan: adenina (A), timina (T), guanina (G) y citosina (C). Cada nucleótido se une al siguiente mediante un esqueleto de azúcar y fosfato, lo que da lugar a una cadena larga. Dos cadenas de ese tipo se aparean entre sí —A con T, G con C— y se enrollan en la célebre doble hélice.

La estructura de doble cadena es el origen de la propiedad más útil del ADN: cada hebra contiene la información necesaria para reconstruir la otra. Por eso el ADN puede copiarse con alta fidelidad, y por eso un daño en una hebra es en principio corregible a partir de la otra. La química de la molécula fue la respuesta a la pregunta de cómo podía funcionar físicamente la herencia.

En una célula humana típica, el ADN se organiza en 46 cromosomas (23 pares) que suman unos 3.000 millones de pares de bases. Puesto de extremo a extremo, son unos dos metros de molécula empaquetados en un núcleo de unas pocas micras de diámetro. El empaquetamiento no es arbitrario: es jerárquico, con el ADN enrollado alrededor de proteínas histónicas, organizado en bucles y dominios y plegado en territorios dentro del núcleo. El lugar que ocupa un gen en esa estructura influye en si se lee y en cuándo se lee.
...
Lo que el dogma central no dice, y lo que a veces se le hace decir por error, es que la información fluya *solo* desde el ADN hacia fuera. Nada dice sobre cómo se regula la *expresión* del ADN, en la que hay un flujo considerable de información en sentido contrario: del entorno al estado de la cromatina y de ahí a la actividad génica.

## Lo que el ADN determina

El ADN determina el repertorio de proteínas que una célula puede construir. Determina (dentro de ciertos límites) la estructura de esas proteínas. Determina (dentro de ciertos límites) cuándo y dónde es probable que se expresen. Y determina las restricciones del desarrollo dentro de las cuales una célula o un organismo pueden variar.

En algunos casos, un único cambio en el ADN produce un único cambio fenotípico con gran fiabilidad: la anemia falciforme, la fibrosis quística, la acondroplasia. Son las enfermedades que encajan en la imagen popular del «gen de X». Existen; son reales; son importantes para las personas afectadas. Y son también una fracción pequeña de los casos en los que el ADN cuenta.

En la mayoría de los caracteres —la estatura, la susceptibilidad a enfermedades comunes, las predisposiciones conductuales— el cuadro es fundamentalmente poligénico. Cientos o miles de variantes, cada una de efecto pequeño, se combinan para producir el componente heredable de la variación. Los efectos son estadísticos, no deterministas. Describen poblaciones, no individuos.

## Lo que el ADN no determina
