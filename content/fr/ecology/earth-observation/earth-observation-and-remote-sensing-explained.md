...
Les articles qui s'y rattachent poussent chaque élément plus loin : qu'est-ce que la télédétection, le programme Landsat, les satellites Sentinel, le système MODIS, le NDVI et la famille plus large des indices de végétation, la détection des changements d'occupation du sol, le [suivi satellitaire de la déforestation](/fr/ecology/earth-observation/satellite-deforestation-monitoring), la surveillance des incendies depuis l'espace, les systèmes de surveillance de la sécheresse, les observations de la couleur de l'océan, l'altimétrie satellitaire, les produits de données d'observation de la Terre, le programme Copernicus, et un exposé franc des [limites et de l'incertitude de la télédétection](/fr/ecology/earth-observation/remote-sensing-limitations-and-uncertainty). Ensemble, ils expliquent comment la planète est observée depuis l'orbite, et comment lire ce que cette observation produit.
