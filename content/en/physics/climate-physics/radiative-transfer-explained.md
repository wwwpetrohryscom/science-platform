...
Three results fix what an object emits if it emits as a blackbody. Planck's law gives the full spectral shape as a function of temperature alone. Stefan's law gives the total: the flux is the fourth power of temperature multiplied by a constant that CODATA now fixes exactly, at 5.670374419 × 10⁻⁸ W m⁻² K⁻⁴. Wien's displacement law gives the position of the peak.
