...
**Photons below the bandgap pass through.** A solar cell's bandgap defines the minimum [photon](/en/physics/quantum-basics/electromagnetic-spectrum-applications) [energy](/en/physics/energy/perovskite-stack-field-stability) that can excite an electron across it. Photons with less [energy](/en/physics/energy/perovskite-stack-field-stability) are not absorbed — they pass through, contributing nothing. For a typical silicon bandgap (1.1 eV), this discards a large fraction of the long-wavelength solar spectrum.
...
The Shockley-Queisser limit applies to single-junction [cells](/en/biology/cells/what-is-a-cell) under standard illumination. Three known directions sidestep it.
...
Each of these is a real direction of research. None of them violates the underlying [thermodynamics](/en/physics/thermodynamics/earth-energy-budget-and-the-second-law); they each change the conditions under which the thermodynamic argument applies.
...
Multi-junction approaches — particularly [perovskite](/en/physics/energy/perovskite-stack-field-stability)-silicon tandems — sit on a different cost curve. Their efficiency ceiling is meaningfully higher; their manufacturing maturity is much lower. The question for the next decade is whether the manufacturing curve for tandems can be brought down fast enough to make them economical at scale before the silicon cost decline saturates.

Concentrator [photovoltaics](/en/physics/energy/perovskite-stack-field-stability) sit on yet another curve. Their thermodynamic ceiling is high but their balance-of-system costs (tracking, cooling, optics) are high enough that they have remained a niche even as the underlying cell efficiencies have improved.
...
4. **Nature** — [Nature research journals](https://www.nature.com/). Peer-reviewed energy-[materials](/en/physics/energy/perovskite-stack-field-stability) and photovoltaic literature.
