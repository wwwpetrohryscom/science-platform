...
That number now rests on a defined constant rather than a substance. Since May 2019 the SI has fixed the Boltzmann constant at exactly 1.380649 × 10⁻²³ J K⁻¹, and the kelvin follows from it; the CODATA listing carries no uncertainty because there is none to carry. The previous definition, adopted in 1954, made the kelvin 1/273.16 of the triple-point temperature of water, and NIST notes the weakness in that arrangement: extrapolating from the water triple point to very high or very low temperatures is problematic, which is why 21 further defining points were fixed by international agreement. Absolute zero stays where it was, at −273.15 °C.
