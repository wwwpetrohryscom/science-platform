...
The [uncertainty relation](/en/glossary/uncertainty-relation) σₓσₚ ≥ ħ/2 is usually introduced through a story about a microscope disturbing an electron. That story gets the right inequality for the wrong reason, and the wrong reason then has to be unlearned.
...
10. **NIST** — [Basic atomic spectroscopic data: hydrogen](https://physics.nist.gov/PhysRefData/Handbook/Tables/hydrogentable1.htm). The tabulated ionisation energy of neutral hydrogen, 109 678.7717 cm⁻¹ (13.598 433 eV).
