...
**Ultraviolet (10–390 nm, eV–tens of eV photons).** Begins to dissociate chemical bonds. Stratospheric ozone absorbs UV-B and UV-C, protecting surface biology. The WHO maintains [reference health guidance on ultraviolet radiation](https://www.who.int/health-topics/ultraviolet-radiation); NOAA's [ozone and water vapour monitoring](https://gml.noaa.gov/ozwv/) documents the atmospheric column.

**X-rays (10 nm to 0.01 nm, hundreds of eV to keV photons).** Eject inner-shell electrons from atoms; at higher energies, ionize matter directly. Astrophysical X-rays are generated by hot plasma — the corona of the Sun, accretion disks, supernova remnants. NASA's [Chandra](https://chandra.harvard.edu/) observatory and ESA's XMM-Newton are the primary X-ray observatories.
...
It does not provide medical or safety guidance for radiation exposure. UV, X-ray, and gamma-ray exposure carry biological risks that depend on dose, wavelength, and tissue. This page describes the physics; it is not radiation-safety guidance, and any applied use should rest on the relevant national or WHO exposure standards rather than on this description.
...
2. **NIST** — [Reference data on photon interactions and radiometry](https://www.nist.gov/). Standards for photon-matter cross sections and radiometric measurement.
3. **CERN** — [High-energy physics reference](https://home.cern/). Reference on gamma-ray and particle-physics applications.
4. **American Physical Society — Reviews of Modern Physics** — [Peer-reviewed reviews of fundamental electromagnetism](https://journals.aps.org/rmp/). Authoritative review literature on photon physics.
