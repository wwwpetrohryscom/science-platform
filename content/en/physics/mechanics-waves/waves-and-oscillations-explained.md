...
Drive an oscillator at its natural frequency and the amplitude builds until dissipation balances the input. That is [resonance](/en/glossary/resonance), and it is genuinely responsible for a great deal — the selectivity of a radio receiver, the tone of an organ pipe, the response of a building to ground shaking.
...
5. **USGS** — [P waves](https://www.usgs.gov/media/images/p-waves) and [S waves](https://www.usgs.gov/media/images/s-wavesgif). Definitions of the compressional and shear body waves.
6. **USGS** — [Shadow zone](https://www.usgs.gov/media/videos/shadow-zone). S waves stopped by the liquid core and P waves refracted by it.
7. **USGS** — [Earthquake magnitude, energy release, and shaking intensity](https://www.usgs.gov/programs/earthquake-hazards/earthquake-magnitude-energy-release-and-shaking-intensity). The energy released per whole-number step in magnitude.
8. **NASA** — [Anatomy of an electromagnetic wave](https://science.nasa.gov/ems/02_anatomy/). Wavelength, frequency and energy as descriptions of a propagating wave.
