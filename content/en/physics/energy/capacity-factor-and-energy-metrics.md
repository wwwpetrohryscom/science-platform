...
The [levelised cost of electricity](/en/glossary/levelised-cost) divides the discounted lifetime cost of a plant by its discounted lifetime generation. The second discounting is the part that gets forgotten: a megawatt-hour produced in year 20 counts for less than one produced in year 2, so the discount rate penalises long-lived, capital-heavy assets twice over.
