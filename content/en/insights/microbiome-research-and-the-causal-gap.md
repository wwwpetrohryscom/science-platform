...
**Contamination.** Extraction kits and laboratory reagents carry bacterial DNA. Work published in *BMC Biology* showed that this contamination is ubiquitous, varies between kit batches, affects both 16S surveys and shotgun metagenomics, and dominates results when the sample itself has low microbial biomass. The consequence is not hypothetical: a widely cited claim that tumour and blood samples carry diagnostic microbial signatures was retracted from *Nature* in 2024 after reanalysis, and the low-biomass problem was central to the dispute.
