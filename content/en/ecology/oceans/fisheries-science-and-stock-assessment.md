...
On that fixed list, the FAO assessed 62.3 per cent of stocks as being fished within biologically sustainable levels in 2021, down 2.3 percentage points from 2019 and down from 90 per cent in 1974. Weighting by landings rather than counting each stock equally raises the figure to 76.9 per cent, because the largest and most valuable stocks are the ones that get assessed and managed most intensively. The regional spread is wider than either global number suggests: the Northeast Pacific and Northeast Atlantic sat between 76 and 84 per cent sustainable, while the Southeast Pacific was at 33.3 per cent and the Mediterranean and Black Sea at 37.5 per cent.
