...
| 2,344 Pg C (2000) | 3 m | one of only two entries reaching below one metre |
| 3,000 Pg C (2010) | 3 m | the other, and 28 per cent higher for the same depth |
...
8. **Science** — [Crediting agricultural soil carbon sequestration](https://pubmed.ncbi.nlm.nih.gov/35298251/). The published summary that regional consistency is necessary for carbon credit integrity; the full policy forum is paywalled.
