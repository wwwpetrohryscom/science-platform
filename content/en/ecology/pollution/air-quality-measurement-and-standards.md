...
Regulated air pollutants have not improved uniformly, and the exception is instructive. Between 1980 and 2024, US annual average concentrations of carbon monoxide fell 87%, one-hour sulfur dioxide 95% and annual nitrogen dioxide 69%. Eight-hour ozone fell 29% over the same period, and only 7% since 2010 — even though emissions of its two main precursor families, nitrogen oxides and volatile organic compounds, fell 75% and 61% respectively since 1980.

Ozone is not emitted. It is produced photochemically from those precursors, and the production rate is not proportional to either: in some regimes cutting nitrogen oxides raises local ozone before it lowers it. A secondary pollutant therefore breaks the intuition that proportional emission cuts buy proportional air quality improvement. Ammonia has a comparable role in secondary particle formation, traced in [the reactive nitrogen cascade](/en/ecology/pollution/nitrogen-pollution-and-eutrophication).
