...
There is a fourth loss, and it is the largest. The index is reported day by day, and no single day's value carries information about the annual mean — while the mortality evidence rests heavily on long-term average exposure, as set out in [the health evidence on fine particles](/en/ecology/pollution/particulate-matter-and-health-evidence). The 2024 revision narrowed that gap for fine particles by pinning the Good/Moderate boundary to the level of the annual standard, but what gets reported is still a statement about a single day.

## Two limits for the same air

The World Health Organization's 2021 guideline levels are health-derived and carry no feasibility constraint: 5 µg/m³ annual and 15 µg/m³ over 24 hours for fine particles, 15 and 45 µg/m³ for PM10, and 10 µg/m³ annual for nitrogen dioxide. The European Union's binding annual limit values, in force from 2015 and 2010 respectively, are 25 µg/m³ for fine particles and 40 µg/m³ for nitrogen dioxide, with an ozone target value of 120 µg/m³ as a daily eight-hour maximum, permitting 25 exceedance days averaged over three years. Those limits are themselves being revised: a recast Ambient Air Quality Directive entered into force in December 2024, cutting the annual fine-particle limit value by more than half from 2030, with Member States given two years to transpose it.
...
9. **Aerosol and Air Quality Research** — [Practical guidance for using PurpleAir particle monitors for indoor and outdoor measurements in community field studies](https://pmc.ncbi.nlm.nih.gov/articles/PMC12339596/). Collocation precision, correction factors and data-completeness rates in a residential deployment.
10. **European Commission** — [New pollution rules come into effect for cleaner air by 2030](https://environment.ec.europa.eu/news/new-pollution-rules-come-effect-cleaner-air-2030-2024-12-10_en). Entry into force of the recast Ambient Air Quality Directive, the cut to the annual fine-particle limit value and the transposition deadline.
