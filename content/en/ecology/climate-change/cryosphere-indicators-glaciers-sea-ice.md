...
Sea ice is the floating frozen seawater that covers parts of the Arctic and Southern oceans on a seasonal cycle. The two operational indicators are sea-ice *extent* (the area of ocean with at least 15% ice concentration) and sea-ice *area* (the area-weighted total of ice fractions). They differ by a factor that depends on how much partial-cover ice is in the field.

The U.S. [National Snow and Ice Data Center](https://nsidc.org/) maintains the reference satellite passive-microwave record beginning in 1979. The instrument series — NASA's Nimbus-7 SMMR followed by the DMSP SSM/I and SSMIS sensors — has tracked daily sea-ice extent for both poles continuously, with cross-calibration across the instrument transitions. Companion products from ESA's CryoSat-2 measure ice thickness, which combined with extent gives ice volume — a stronger physical indicator than extent alone but with shorter record length.
...
Glaciers are land ice on mountain ranges and high-latitude ice fields, distinct from the continental ice sheets. The reference indicator is *mass balance* — the net gain or loss of ice per year, typically reported in meters of water-equivalent per year averaged over the glacier surface.
...
The Greenland and Antarctic ice sheets are the two continental ice masses that dominate the cryosphere's contribution to long-term sea level. They are distinct from glaciers in physics: ice flow, basal hydrology, marine ice-cliff dynamics, and ice-shelf buttressing all matter for ice-sheet mass balance in ways that mountain-glacier calculations do not require.

The reference observation systems are satellite gravimetry (NASA/DLR's GRACE and GRACE-FO missions), satellite altimetry (NASA's ICESat and ICESat-2, ESA's CryoSat-2), and input-output methods that compare mass gain from precipitation against mass loss from surface melt and ice discharge. The three approaches use largely independent observations and have been intercompared in the Ice Sheet Mass Balance Intercomparison Exercise (IMBIE) project; their agreement gives the assessment in [IPCC AR6 WG1 Chapter 9](https://www.ipcc.ch/report/ar6/wg1/) its confidence range.

Greenland has been losing mass at an accelerating rate since the early 2000s, dominated by increased surface melt in the south and ice discharge from major outlet glaciers. Antarctica's mass loss is concentrated in the West Antarctic Ice Sheet, driven by basal melt under floating ice shelves that buttress upstream grounded ice. The [NSIDC](https://nsidc.org/) and NASA mission pages publish the operational records.

Ice-sheet dynamics is the largest source of uncertainty in 21st-century [sea-level projections](/en/ecology/climate-change/climate-models-projections-uncertainty), because the relevant mechanisms — marine ice-cliff instability, accelerated ice-shelf collapse — are not fully constrained by the historical observational record alone.

## Snow cover and permafrost

Snow cover is the seasonal ice indicator on land. NSIDC and NOAA maintain hemispheric snow-cover-extent records from satellite. Northern Hemisphere June snow extent has declined significantly since the satellite era began; the regional pattern is more variable than the hemispheric trend. Snow cover modifies albedo on land the way sea ice modifies it over the ocean.

Permafrost — perennially frozen ground in high-latitude and high-altitude regions — is harder to observe globally because the indicator is subsurface. Permafrost temperature monitoring networks coordinated through the Global Terrestrial Network for Permafrost provide the long-term record. The [IPCC AR6 WG1](https://www.ipcc.ch/report/ar6/wg1/) review summarizes warming permafrost temperatures and increasing thaw depths across most monitored sites. Permafrost matters for carbon-cycle feedbacks because thawing soils release CO₂ and methane — a feedback covered in the [carbon-cycle feedbacks](/en/ecology/climate-change/carbon-cycle-feedbacks) piece.

## Why the cryosphere indicators are read together
...
Three methodology notes deserve attention.

**Satellite-era only, mostly.** Most cryosphere records start in 1979 (sea ice) or later (gravimetry from 2002). Pre-satellite reconstructions exist for some indicators (sea-ice from ship logs, glacier length from historical photography and moraine dating), but the high-precision records are short relative to the climate signal being assessed.
