...
The U.S. [National Snow and Ice Data Center](https://nsidc.org/) maintains the reference satellite passive-microwave record beginning in 1979. The same instrument family — DMSP SSMR through SSMI through SSMIS — has tracked daily sea-ice extent for both poles continuously, calibrated across instrument transitions. Companion products from ESA's CryoSat-2 measure ice thickness, which combined with extent gives ice volume — a stronger physical indicator than extent alone but with shorter record length.
