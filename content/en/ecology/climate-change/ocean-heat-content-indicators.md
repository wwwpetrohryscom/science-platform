...
## Why the surface record is noisier than the ocean record
...
The post-2005 OHC record, anchored by the Argo network, shows monotonic positive accumulation in the upper ocean. AR6 reports a high likelihood that ocean warming through the end of the historical record was unprecedented in at least the last several thousand years and that the rate of upper-ocean warming has roughly doubled since 1971. The deep-ocean component is smaller but consistent.

The fact that the trend is monotonic — every five-year window adds energy, with no sustained reversals — is one reason why claims of a global "warming pause" do not survive contact with the OHC data. The atmospheric pause years of the early 2000s correspond to no pause at all in the ocean record.
