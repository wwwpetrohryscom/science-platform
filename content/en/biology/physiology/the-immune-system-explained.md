...
Immunological memory was long treated as the defining property of vertebrate adaptive immunity. It is not exclusive to it. Plants defend themselves with a two-tiered innate system: cell-surface pattern recognition receptors detecting conserved microbial molecules, and intracellular nucleotide-binding leucine-rich repeat receptors recognising pathogen effectors, the first of which was cloned in 1992. The two tiers interact rather than operating in series, and plants have no lymphocytes and no somatic receptor rearrangement of the vertebrate kind.
