...
One structural question sits underneath all of the arithmetic above and is not resolved. A textbook diagram draws the respiratory complexes as a fixed linear sequence, but whether they assemble into stable supercomplexes with kinetic consequences, or simply diffuse in the membrane and collide, has been argued in both directions since the 1960s — the solid-state and fluid-state models. A [review in the *Journal of Molecular Medicine*](https://pmc.ncbi.nlm.nih.gov/articles/PMC7785696/) records that structural studies have since challenged the substrate-channelling role once attributed to supercomplexes, so how much functional channelling of electrons actually occurs remains contested.
...
8. **Journal of Molecular Medicine (PubMed Central)** — [Mitochondrial respiratory supercomplexes in mammalian cells: structural versus functional role](https://pmc.ncbi.nlm.nih.gov/articles/PMC7785696/). The solid-state and fluid-state models of respiratory-chain organisation and the contested evidence for substrate channelling.
