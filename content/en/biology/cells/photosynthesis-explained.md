...
An isolated chlorophyll molecule that absorbs [a quantum of visible light](/en/glossary/photon) holds the excited state for about four nanoseconds in vivo before relaxing to the ground state and losing the energy. Four nanoseconds is a long time chemically and a very short time biologically, so a reaction centre that waited for photons to land on it directly would spend most of its existence idle.
...
Photosystem II performs the step everything else depends on: it takes electrons from water. Splitting water requires more than 2 eV, which no ordinary biological cofactor can supply. Charge separation solves the problem by generating P680⁺, whose oxidation potential is estimated at +1.2 to +1.3 V — the highest known in biology.
...
3. **Journal of the Royal Society Interface (PubMed Central)** — [Photosynthetic light harvesting: excitons and coherence](https://pmc.ncbi.nlm.nih.gov/articles/PMC3899860/). Antenna size per reaction centre, energy-transfer timescales, and measured quantum efficiencies.
...
6. **Annals of Botany (PubMed Central)** — [The CAM lineages of planet Earth](https://pmc.ncbi.nlm.nih.gov/articles/PMC10799995/). CAM genera, families, share of vascular plants, and count of independent origins.
