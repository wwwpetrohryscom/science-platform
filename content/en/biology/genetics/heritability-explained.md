...
| --- | --- | --- | --- |
| Classical twin design | Additive genetic variance, from the excess similarity of identical over fraternal twins, under an AE or ACE model | 0.87–0.93 in men; 0.68–0.84 in women | Identical and fraternal twins share environments to the same degree |
...
A residual gap remains between the 0.45 tagged by common markers and the 0.8-plus estimated from pedigrees. Part of it is incomplete linkage disequilibrium and causal variants at frequencies lower than genotyping arrays sample well — and that frequency spectrum is itself a product of [population history and drift](/en/biology/evolution/genetic-drift-and-population-size) rather than of anything about the trait. Part of it is bias in the estimates themselves, though not in the direction usually assumed. Assortative mating — people pairing non-randomly by height — [biases marker-based heritability estimators upward](https://pmc.ncbi.nlm.nih.gov/articles/PMC8814020/), with height estimates in UK Biobank running 14 to 23 per cent above their corrected values, while its effect on a twin estimate depends on the model fitted: downward under the ACE model, upward under an ADE model. Because it inflates the marker-based figure, assortative mating narrows the apparent gap rather than opening it, and correcting for it would widen the discrepancy that has to be explained. Non-sequence transmission is occasionally offered as a third explanation, but the mammalian evidence reviewed under [epigenetic inheritance and its limits](/en/biology/genetics/epigenetics-explained) does not currently support a contribution on that scale. Which part dominates is not settled, and the honest description of the field is that the two families of estimate have converged without fully reconciling.
...
9. **Nature Communications (via PubMed Central)** — [Assortative mating biases marker-based heritability estimators](https://pmc.ncbi.nlm.nih.gov/articles/PMC8814020/). Direction and size of the assortative-mating bias in marker-based and twin estimates of heritability for height.
