...
A sequence is only useful in the context of everything done to it and with it. [What a genome is](/en/biology/genetics/what-is-a-genome) takes the molecule up to the scale of a whole organism's complement, and explains why genome size predicts almost nothing about complexity. [Replication and repair](/en/biology/genetics/dna-replication-and-repair) is how the sequence is copied faithfully enough to be inherited, and [the mutations that get through](/en/biology/genetics/mutation-types-and-rates) are what remains — quantified, because the per-generation rate is now directly measured rather than inferred.

How a fixed sequence produces different cells is the subject of [gene-expression regulation](/en/biology/genetics/how-gene-expression-is-regulated) and of [epigenetic regulation](/en/biology/genetics/epigenetics-explained), a term that carries a precise technical meaning and a much looser popular one. Two articles cover what the data can and cannot support: [the heritability statistic](/en/biology/genetics/heritability-explained), probably the most misread number in biology, and [genome-wide association studies](/en/biology/genetics/genome-wide-association-studies-explained), where the gap between association and mechanism is the whole story. [Single-cell evo-devo](/en/biology/genetics/single-cell-evo-devo) is where the resolution of these methods is currently changing fastest.
