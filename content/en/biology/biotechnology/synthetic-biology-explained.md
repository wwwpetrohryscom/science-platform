...
The best-documented [metabolic engineering](/en/glossary/metabolic-engineering) programme reconstructed a plant pathway in yeast to supply a precursor of the antimalarial artemisinin. A review of the commercial effort records fermentative production of artemisinic acid at 25 g/L in a strain expressing the full complement of oxidation enzymes from *Artemisia annua*, grown under the same regimen as a parent strain producing 40 g/L of the hydrocarbon precursor — a conversion of about 55 mol per cent. That is a serious industrial titre. What the same review describes next is narrower than the usual telling. The route judged to have reached its performance limits, and to be not cost-effective enough for commercial production, was not the fermentation but the chemistry downstream of it — a conversion of artemisinic acid to artemisinin built to avoid photochemistry, abandoned after the technology transferred between companies and five years of industrialisation work, sending chemists back to the photochemical step it had replaced. The engineered yeast stayed: semi-synthetic artemisinin entered industrial production in 2013, and at the time of the review the rebuilt process was making up to 60 tonnes a year from fermentation-derived artemisinic acid — on the review's account, the only industrial-scale semi-synthesis of the drug then running. Its reservation is about the biology rather than the outcome: that 55 mol per cent conversion leaves, in its words, clear room for improvement in the oxidation of amorphadiene.
