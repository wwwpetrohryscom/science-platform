---
title: Was ist ein Ökosystem? Eine Definition über Flüsse statt Orte
excerpt: Ein Ökosystem ist kein Ort, sondern ein Fluss. Diese Unterscheidung verändert, wie sich über Resilienz und Renaturierung nachdenken lässt – und darüber, was der Naturschutz tatsächlich bewahrt.
type: pillar
...
Der sachliche Gehalt des Wortes „Ökosystem“ lässt sich auf drei messbare Eigenschaften zurückführen.
...
Jedes System, das alle drei besitzt, ist ein Ökosystem. Ein nackter Fels mit Flechten besitzt alle drei (in kleinem Maßstab). Ein Schwimmbecken nicht. An den Rändern ist die Abgrenzung unscharf, und das ist in Ordnung – die meisten brauchbaren Definitionen der Biologie sind an den Rändern unscharf.

## Warum der Maßstab in der Definition steckt
...
Ökosysteme über den Fluss statt über den Ort zu definieren, führt zu mehreren brauchbaren Umformulierungen.

**Renaturierung heißt, den Fluss wieder in Gang zu bringen.** Ein renaturiertes Ökosystem ist eines, in dem die charakteristischen Flüsse in einer Rate wieder eingesetzt haben, die mit der des Referenzzustands vergleichbar ist. Einen Wald aufzuforsten, ohne seine Hydrologie, seine Bodengemeinschaft und seine trophische Struktur wiederherzustellen, ergibt einen Baumbestand, kein Ökosystem.

**Resilienz ist Pufferkapazität.** Ein resilientes Ökosystem ist eines, dessen Flüsse unter einer Störung fortbestehen. Zwei Systeme können identisch aussehen und sich unter Belastung sehr verschieden verhalten, weil sie unterschiedliche Puffer besitzen – unterschiedliche Artenredundanz, unterschiedlichen Bodenkohlenstoff, unterschiedliche funktionale Diversität.
...
Die Definition über Flüsse schließt auch einige populäre, aber wenig hilfreiche Rahmungen aus.

Sie schließt die Vorstellung aus, Ökosysteme hätten einen „natürlichen Zustand“, in den sie zurückgeführt werden sollten. Ökosysteme sind per Definition dynamisch. Es gibt keine statische Referenz; es gibt nur eine gewählte Basislinie.

Sie schließt die strikte Trennung in „wilde“ und „bewirtschaftete“ Ökosysteme aus. Ein intensiv bewirtschafteter Acker lässt weiterhin Energie, Materie und Information zirkulieren – er ist ein Ökosystem, nur eines mit geringer Diversität und anthropogenen Energiesubventionen. Die interessante Frage ist nicht, ob er „natürlich“ ist, sondern wie sich seine Flüsse zu dem verhalten, was zuvor da war.

Sie schließt außerdem die Vorstellung aus, man könne ein Ökosystem bewahren, indem man eine Linie darum zieht. Ökosysteme tauschen Flüsse über ihre Grenzen hinweg aus – Wasser, Nährstoffe, Propagulen, atmosphärische Gase. Eine Linie auf der Karte bewahrt das Substrat; ob sie das Ökosystem bewahrt, hängt davon ab, was diese Linie kreuzt.
...
1. **UNEP** — [Ecosystems and biodiversity](https://www.unep.org/explore-topics/ecosystems). Überblick über Schutz, Wiederherstellung und nachhaltige Nutzung von Ökosystemen.
