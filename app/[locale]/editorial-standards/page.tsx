...
import { EDITORIAL_STANDARDS, POLICY_DOCUMENTS } from "@/lib/editorial";
import { buildMetadata, breadcrumbJsonLd } from "@/lib/seo";
import { DEFAULT_LOCALE, isLocale, localizedPath } from "@/lib/i18n";

type Props = { params: { locale: string } };

const DOC = EDITORIAL_STANDARDS;
...
export default function EditorialStandardsPage({ params }: Props) {
