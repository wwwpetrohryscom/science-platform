...
const CATEGORY = "ecology" as const;
type Props = { params: { locale: string; subtopic: string; slug: string } };

export async function generateStaticParams() {
  // Cartesian product of locales × articles. We pre-render each
  // locale's tree using its own article store so missing translations
  // surface as static pages with the EN-fallback content baked in.
...
export default async function EcologyArticleRoute({ params }: Props) {
